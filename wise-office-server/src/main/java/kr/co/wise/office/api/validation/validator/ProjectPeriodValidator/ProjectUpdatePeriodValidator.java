...
public class ProjectUpdatePeriodValidator implements ConstraintValidator<ValidDateRange, ProjectUpdateRequest> {
    @Override
    public boolean isValid(ProjectUpdateRequest request, ConstraintValidatorContext context) {
