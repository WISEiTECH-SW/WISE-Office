...
export default function SelectProjectMembers({members, searchText, selectedMembers, 
    manager, setSearchText, setSelectedMembers, setManager}
    ...
    <div className="flex flex-col flex-1 overflow-y-auto pl-4">
                ...
                {selectedMembers.length > 0 && (
                    <div
                    className="flex flex-wrap gap-2 border border-gray-300 rounded-md p-3 max-h-[100px] overflow-y-auto shadow-inner mb-6"
                    >
                ...
                <div>
                    ...
                    {selectedMembers.length === 0 ? (
                    <p className="text-sm text-gray-500 italic">참여 인력을 먼저 선택해주세요.</p>
                    ) : (
